<?php 
  require "component/header/header-outtour.php";
?>
	  ...
	  <div class="col">
		<div class="home_content">
		  <div class="home_content_inner">
			<div class="home_title">Tour nước ngoài</div>
			<div class="home_breadcrumbs">
			  <ul class="home_breadcrumbs_list">
				<li class="home_breadcrumb">
				  <a href="?page=home">Home</a>
				</li>
				<li class="home_breadcrumb">Tour nước ngoài</li>
			  </ul>
			</div>
		  </div>
		</div>
	  ...
	  <div class="col">
		<div class="items item_grid clearfix">
		  <?php
			...
			{extract($value);
			  echo
			  "<div class='item clearfix rating_5 box'>
