      ...
      <div class="navbar-header">
        <a href="admin.php" class="navbar-brand">
          <div class="brand-image brand-big" >
            <img src="admin/assets/img/logoAveiroTravel.png" alt="logo" class="logo" style="width: 60px">
          </div>
        ...
        <li class="nav-item dropdown">
          ...
          <ul aria-labelledby="user" class="user-size dropdown-menu">
            <li class="welcome">
              ...
              <img src="admin/assets/img/avatar/avatatuan.jpg" alt="..." class="rounded-circle">
            </li>
            <li>
