                            ...
                            <div class="col-xl-3">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-body">
                                        <div class="mt-5">
                                            <img src="admin/assets/img/logoAveiroTravel.png" style="width: 120px;" class="avatar d-block mx-auto">
                                        </div>
                                        <h3 class="text-center mt-3 mb-1">Aveiro Travel</h3>
                                        <p class="text-center">aveirotravel</h3>@gmail.com</p>
