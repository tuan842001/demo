			  ...
			  <nav>
				<div 
                  class='nav nav-tabs' id='nav-tab' role='tablist'>
                    <a class='nav-item nav-link active' id='tab1-tab' data-toggle='tab' href='#tab1' role='tab' aria-controls='tab1' aria-selected='true'>MÔ TẢ CHUYẾN ĐI</a>
                    <a class='nav-item nav-link' id='tab2-tab' data-toggle='tab' href='#tab2' role='tab' aria-controls='tab2' aria-selected='false'>THỜI GIAN ĐI</a>
                    <a class='nav-item nav-link' id='tab4-tab' data-toggle='tab' href='#tab4' role='tab' aria-controls='tab2' aria-selected='false'>CHI TIẾT TOUR</a></div>
								</nav>
